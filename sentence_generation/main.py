...
nouns = ["mango", "apple", "carrot", "rabbit", "banana", "basketball", "chess", "sun", "wind"]
verbs = ["twists", "cooks", "blows", "bounces", "walks", "jumps", "calls", "stays", "runs", "abides"]
...
def complex_sentence():
  return independent_clause() + ", " + independent_clause() + "."
